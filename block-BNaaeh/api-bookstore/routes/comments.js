...
// POST /api/v2/books/:id/comments - add a comment to a book
commentsRouterV2.post('/:id', async (req, res, next) => {
  ...
  try {
    ...
    var newComment = updatedBook.comments[updatedBook.comments.length - 1]; // Get the last added comment
